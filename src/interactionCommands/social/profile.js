...
module.exports = {
	...
	async execute(client, interaction) {
		...
		if (user.bot)
			if (interaction.replied || interaction.deferred) return interaction.editReply({ content: 'Bots do not have profile!', ephemeral: true });
			else return interaction.reply({ content: 'Bots do not have profile!', ephemeral: true });
