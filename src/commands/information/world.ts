	...
	async execute(client, message) {
		...
		Object.keys(numbers).forEach((key) => {
			...
			let e12 = counter.find((nu) => nu.attribs.class === 'rts-nr-int rts-nr-10e12')
				...
				: '';
			let e9 = counter.find((nu) => nu.attribs.class === 'rts-nr-int rts-nr-10e9') ? counter.find((nu) => nu.attribs.class === 'rts-nr-int rts-nr-10e9').children[0].data : '';
			let e6 = counter.find((nu) => nu.attribs.class === 'rts-nr-int rts-nr-10e6') ? counter.find((nu) => nu.attribs.class === 'rts-nr-int rts-nr-10e6').children[0].data : '';
			let e3 = counter.find((nu) => nu.attribs.class === 'rts-nr-int rts-nr-10e3') ? counter.find((nu) => nu.attribs.class === 'rts-nr-int rts-nr-10e3').children[0].data : '';
			let e0 = counter.find((nu) => nu.attribs.class === 'rts-nr-int rts-nr-10e0') ? counter.find((nu) => nu.attribs.class === 'rts-nr-int rts-nr-10e0').children[0].data : '';
			let obj = {
				objId: objId,
				id: id,
