...
const { ModelServer, ModelInfrs, ModelMutes, ModelTempban } = require('../../utils/models');
const { Convert } = require('../../utils/methods/functions');
module.exports = {
	name: 'modinf',
	...
	async execute(client, message, args) {
		...
		let { mod, config } = require(`../../utils/lang/${serverConfig.lang}.js`);
