...
export const music = {
	...
	error_stream:
		"There was an error when attempting to play {video}, **it is highly possible that it is age restricted or that it's from a generated channel (and therefore I can't play it - try searching for its lyrics)**. More info below\n\n",
	...
	insufficient_quota: "There's a song being generated right now or the maximum number of daily songs has been generated.",
